<?php
/**
 * SingleUseCouponsCampaignCopyRequest
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * SingleUseCouponsCampaignCopyRequest Class Doc Comment
 *
 * @category Class
 * @description Contains payload for copying a campaign.
 * @package  PkIo
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SingleUseCouponsCampaignCopyRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'single_use_couponsCampaignCopyRequest';
...
'passTypeIdentifier' => 'getPassTypeIdentifier'    ];
     ...
     * Sets id
     *
     * @param string $id uuid of the campaign to copy.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name Optional name for the new campaign.
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param \PkIo\Model\IoProjectStatus[] $status Status to set the copied campaign to.
     *
     * @return $this
     */
